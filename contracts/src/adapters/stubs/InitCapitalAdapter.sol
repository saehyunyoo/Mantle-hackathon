...
/**
 * @title InitCapitalAdapter — stub for Phase 2+
 * Money-market protocol on Mantle. Treated as LENDING kind for routing.
 */
contract InitCapitalAdapter is IJionAdapter {
    error NotImplemented();

    function name() external pure returns (string memory) { return "Init-Capital"; }
